...
# 
# 
# OS: Linux Mint 22.1 - Kernel version: 6.11.0-17-generic
# User:  - Hostname: 
# Uptime: 10:53:47 - Time and date: 11:57 26/02/2025
# CPU used: 52% (CPU0: 51% - CPU1: 55% - CPU2: 52% - CPU3: 50%)
# ▕████████████████░░░░░░░░░░░░░░░▏
# CPU frequency: 0.92GHz - Scaling governor: powersave
# CPU temperature: 34.0°C
# Load average: 0.21 0.27 0.35
# RAM used: 27% (4.16GB / 15.49GB) - SWAP used: 0% (0.00GB / 0.00GB)
# ▕████████░░░░░░░░░░░░░░░░░░░░░░░▏-▕░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░▏
# Processes: 256 (running=1, sleeping=190, idle=64, stopped=0, zombie=0, other=1)
# Disk used: 43.1% (201.73GB / 467.91GB)
# ▕█████████████░░░░░░░░░░░░░░░░░░▏
# Disk temperature: 30.9°C
# WIFI signal: 60% - Speed: 97.6Mb/s - Lan: OBRIEN 5 - IP: 192.168.0.208
# ▕██████████████████░░░░░░░░░░░░░▏
# WIFI temperature: 41.0°C
# Battery: 41% - Mode: Discharging
# ▕████████████░░░░░░░░░░░░░░░░░░░▏
...
# CPU frequency: XGHz - Scaling_governor: X
...
# WIFI signal: X% - Speed: XMb/s - Lan: - IP:
# ▕████████████░░░░░░░░░░░░░░░░░░░▏
# WIFI temperature: X°C
def get_wifi_info():
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        try:
            ...
            while True:
                os.system('clear')
                print("\a", end="", flush=True)  # Emite un pitido
                main()
